...
from core.views import products, home, product_details, add_to_cart, empty_cart, shopping_cart, checkout, remove_shopping_cart_item, instagram_feed, contact
...
urlpatterns = [
    ...
    path("instagram-feed/", instagram_feed, name="instagram_feed"),
